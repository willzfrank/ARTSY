export const featured_products = [
  {
    ...
    title: 'French Model',
    creatorCount: '32',
    desc: "The use of light and shadow adds depth and dimension to the piece, highlighting the model's form and adding to the overall atmosphere of the artwork. Overall, the piece is a stunning example of the artist's skill and ability to capture the beauty of the human form.",
  },
  {
    id: 'ftp2',
    ...
    creatorCount: '25',
    desc: 'The artwork portrays a scene from ancient Egypt, featuring intricate hieroglyphics and beautifully detailed figures. The central figure is the Pharaoh, seated on his throne and adorned in lavish garments. Surrounding him are his loyal subjects, bowing in reverence to their leader.',
  },
  {
    id: 'ftp3',
    ...
    title: 'Old Sculpture',
    creatorCount: '1',
    desc: "The ancient sculpture depicts a regal figure, carved in fine marble. The figure stands tall and proud, with a dignified expression on its face. The intricate details of the sculpture are impressive, from the delicate folds of the figure's clothing to the finely crafted features of its face. ",
  },
];
